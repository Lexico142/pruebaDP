...
give @a bow[rarity="epic",enchantments={"minecraft:power":4,"minecraft:punch":2,"minecraft:unbreaking":3},enchantment_glint_override=true] 1
give @a arrow[rarity="epic",enchantment_glint_override=false] 256
